...
LICENSE_${PN}-dev = "GPL-2.0-or-later"
LICENSE_${PN}-staticdev = "GPL-2.0-or-later"
LICENSE_${PN}-doc = "GPL-2.0-or-later"
LICENSE_${PN}-dbg = "GPL-2.0-or-later"
LICENSE_${PN}-locale = "GPL-2.0-or-later"
LICENSE_liblzma = "PD"
